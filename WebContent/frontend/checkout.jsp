...
<title>DkBookStore.com CheckOut</title>
																		...
																		<td class="col-sm-8 col-md-6">
																			<div class="media" align="center">
																				<a class="thumbnail pull-left"
																					href="view_book?id=${item.key.bookId}"> <img
																					class="media-object"
																				...
																				<div class="media-body">
																					<h4 class="media-heading">
																						<a href="view_book?id=${item.key.bookId}">${item.key.title}</a>
																					</h4>
																					<h5 class="media-heading">
																						<a href="view_book?id=${item.key.bookId}">${item.key.author}</a>
																					</h5>
																					<span>Status: </span>
																					<c:choose>
									...
									<table class="table table-striped" style="font-weight: bold;">
										...
										<tr>
											<td style="width: 175px;"><label for="id_first_name">Recipient
													Phone:</label></td>
											<td><input class="form-control" type="text"
												name="recipientPhone" value="${loggedCustomer.phoneNumber}" /></td>
										</tr>
										<tr>
