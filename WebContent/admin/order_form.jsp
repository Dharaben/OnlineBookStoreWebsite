...
<title>Edit Order- DK Bookstore Administration</title>
<link rel="stylesheet"
					...
					<tbody>
						...
						<tr>
							...
							<option value="OrderPlaced"
										<c:if test="${order.orderStatus eq 'OrderPlaced' }">selected='selected'</c:if>>Order Placed</option>
									...
									<option value="Shipped"
										<c:if test="${order.orderStatus eq 'Shipped' }">selected='selected'</c:if>>Shipped</option>
									...
									<option value="Completed"
										...
										<c:if test="${order.orderStatus eq 'Returned' }">selected='selected'</c:if>>Returned</option>
				...
				<tbody>
					...
					<tr>
						...
						<td style="color: red;"><b><fmt:formatNumber
									value="${order.orderTotal}" type="currency" /></b></td>
						<td></td>
					</tr>
				</tbody>
			</table>
