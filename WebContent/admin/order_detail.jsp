...
<title>Order Details - DK Bookstore Administration</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="container">
		<div class="table-wrapper">
			...
			<td style="color: red;"> 
			<b>TOTAL: </b></td>
		<td style="color: red;">${order.bookCopies}</td>
			<td style="color: red;"><b><fmt:formatNumber value="${order.orderTotal}" type="currency" /></b></td>
			</tr>
				</tbody>
			</table>
		</div>
